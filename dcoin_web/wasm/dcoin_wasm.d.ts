...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfe13d680dbc07714: (a: number, b: number) => void;
  readonly closure107_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure270_externref_shim: (a: number, b: number, c: any, d: any) => void;
